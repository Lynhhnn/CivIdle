export const FR = {
   ...
   GrottaAzzurraDesc: "Une fois découverte, tous les bâtiments de catégorie I gagnent +5 Niveau",
   ...
   RebornModalDescV2: "Vous commencerez un nouvel empire mais vous pourrez récuperer tous les personnages illustres <b>de cette partie</b>, qui deviendront alors <b>permanents</b>. Vous aurez également le choix parmi une liste de personnages illustres bonus en fonction de la <b>valeur totale de votre empire</b>",
   ...
   ZagrosMountains: "Montagnes de Zagros",
   ZagrosMountainsDesc: "Tous les batiments adjacents qui ont un multiplicateur de production inferieur a 5 gagnent +2 de Multiplicateur de production. Doubble l'effet de Nebuchadnezzar II (Personnage illustre)",
   Zenobia: "Zénobie",
   ZenobiaDesc: "+%{value}h Petra Warp Storage",
   ZhengHe: "Zheng He",
   ZigguratOfUr: "Ziggurat of Ur",
   ZigguratOfUrDesc: "Tous les 10 de bonheur (cappé) ajoute +1 de multiplicateur de production à tous les batiments (max = nombre d'ages débloqués/2). Les Merveilles (Naturelles inclues) ne produisent plus +1 de bonheur. L'effet peut être arrêté",
   Zoroaster: "Zoroastre",
};
